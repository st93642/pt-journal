/// Header bar module with Open/Save buttons and sidebar toggle
use gtk4::prelude::*;
use gtk4::{HeaderBar, Button};

/// Create the application header bar
pub fn create_header_bar() -> (HeaderBar, Button, Button, Button) {
    ...
    (header, btn_open, btn_save, btn_sidebar)
}
